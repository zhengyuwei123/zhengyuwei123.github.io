...
1. Mini Review: Algorithms for Photonic Spiking Neural Networks [<a href="assets/CVandCourseProjects/A_review_on_photonic_spiking_neural_network_algorithms.pdf" target="_blank">PDF</a>]
     <div style="display: flex; justify-content: space-between; font-style: italic;">
...
2. Speckle Imaging through Scattering Layers [<a href="assets/CVandCourseProjects/Biomedical_Photonics_and_Imaging_Project.pdf" target="_blank">PDF</a>]
     <div style="display: flex; justify-content: space-between; font-style: italic;">
